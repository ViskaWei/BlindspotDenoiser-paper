...
% === Polarity-flip diagnostic removed per 2026-07-01 advisor meeting (confusing; absorption->emission flip essentially never happens; deferred to thesis). Kept for recovery. ===
\iffalse
...
% \item \textbf{Polarity-flip rate}: Equation~\ref{eq:polarity_flip}, reported on $\mathcal{P}$, $\mathcal{P}_{-}$, and $\mathcal{P}_{+}$.  % removed 2026-07-01
...
$\quad 8662$~\AA{} & $1.02$ & $\mathbf{0.147}$ \\
\hline
% polarity rows removed 2026-07-01 advisor meeting
...
% === input--output S/N density plot (fig_snr_improvement_log) commented out per 2026-07-01 advisor meeting: output-S/N is not directly measurable (no per-pixel sigma on the denoised output); to be superseded by RMSE-based reporting. Kept for recovery. ===
\iffalse
