...
$\quad 8498$~\AA   & $0.737$ [$0.709$, $0.764$] & $\mathbf{0.121}$ [$\mathbf{0.106}$, $\mathbf{0.129}$] & $-0.616$ [$-0.621$, $-0.460$] \\
$\quad 8542$~\AA   & $0.328$ [$0.318$, $0.339$] & $\mathbf{0.098}$ [$\mathbf{0.083}$, $\mathbf{0.103}$] & $-0.230$ [$-0.281$, $-0.208$] \\
$\quad 8662$~\AA   & $1.02$ [$0.983$, $1.066$] & $\mathbf{0.147}$ [$\mathbf{0.131}$, $\mathbf{0.161}$] & $-0.874$ [$-0.996$, $-0.735$] \\
$\quad$Triplet mean & $0.695$ [$0.676$, $0.718$] & $\mathbf{0.122}$ [$\mathbf{0.109}$, $\mathbf{0.127}$] & $-0.573$ [$-0.620$, $-0.491$] \\
\hline
